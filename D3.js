...
console.log("peso totale della crew", crewMass);
...
//    Object.defineProperty(starWarsCharacters[i].gender, "robot");
//  }
//}
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  if (characters[i] === femaleCharacters[0] || characters[i] === femaleCharacters[1]) characters.splice(i, 1);
}
console.log(characters.length);
...
console.log(
  ...
  "anno di nascita:",
  starWarsCharacters[randomNumber].birth_year,
  "sesso:",
